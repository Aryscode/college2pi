...
class Name extends Component {  
    render() {
        return (
            <div className="Name" style={{backgroundColor:"gold", fontFamily:"cursive", borderRadius:"7px"}}>
                {this.props.name}
            </div>
        )
    }       
